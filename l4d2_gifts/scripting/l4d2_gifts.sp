...
ConVar cvar_gift_enable, cvar_gift_life, cvar_gift_chance, cvar_gift_chance2, cvar_gift_maxcollectMap,
	cvar_gift_maxcollectRound,cvar_gift_Precache, cvar_gift_Announce, cvar_gift_DecayDecay, cvar_gift_MaxIncapCount;
...
bool g_RoundEnd, g_bSpecialMap, g_bAnnounce;
...
public void OnPluginStart()
{
	...
	cvar_gift_Precache = CreateConVar("l4d2_gifts_special_map",	"c1m3_mall",	"Use gift model only on these maps, separate by commas (no spaces). precache other models will crash the server.", FCVAR_NOTIFY );
...
public void OnMapStart()
{
	...
	char sCvar[256];
	cvar_gift_Precache.GetString(sCvar, sizeof(sCvar));
	...
	{
		g_iCountGifts = 1;
		strcopy(g_sModel[0], MAX_STRING_WIDTH, "models/items/l4d_gift.mdl");
		Format(g_sTypeModel[0], 10, "physics");
		Format(g_sTypeGift[0], 10, "special");
		g_fScale[0] = 1.0;
	}
	else
	{
